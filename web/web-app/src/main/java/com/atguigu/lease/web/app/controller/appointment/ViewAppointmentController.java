...
public class ViewAppointmentController {
    ...
    public Result<List<AppointmentItemVo>> listItem() {
        List<AppointmentItemVo> list = viewAppointmentService.getAppointmentList(LoginUserHolder.getLoginUser().getUserId());
    ...
    public Result<AppointmentDetailVo> getDetailById(Long id) {
        AppointmentDetailVo appointmentDetailVo = viewAppointmentService.getAppointmentDetailVo(id);

...
public class LeaseAgreementController {
    ...
    public Result<List<AgreementItemVo>> listItem() {
        ...
        List<AgreementItemVo> agreementItemVoList = leaseAgreementService.getAgreementItemVo(userId);
    ...
    public Result<AgreementDetailVo> getDetailById(@RequestParam Long id) {
        AgreementDetailVo agreementDetailVo = leaseAgreementService.getAgreementDetailVo(id);

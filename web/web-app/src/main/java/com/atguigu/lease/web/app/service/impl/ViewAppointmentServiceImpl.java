...
public class ViewAppointmentServiceImpl extends ServiceImpl<ViewAppointmentMapper, ViewAppointment>
    ...
    @Override
    public List<AppointmentItemVo> getAppointmentList(Long userId) {
        return viewAppointmentMapper.selectAppointmentList(userId);
    }
    ...
    public AppointmentDetailVo getAppointmentDetailVo(Long id) {
        ...
        ApartmentItemVo apartmentItemVo = apartmentInfoService.selectOneByApartmentId(apartmentId);
